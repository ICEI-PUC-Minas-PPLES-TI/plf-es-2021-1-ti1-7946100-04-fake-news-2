...
function check_logged_and_edit(){
    ...
    document.getElementById("save_without_edit").style.display = "flex";
    document.getElementById("save_with_edit").style.display = "none";


    if(localStorage.getItem('loggedId') != null || localStorage.getItem('loggedId') != "null"){
        document.getElementById("form_adm").style.display = "block";
        document.getElementById("form_not_adm").style.display = "none";   
    }else{
        document.getElementById("form_adm").style.display = "none";
        document.getElementById("form_not_adm").style.display = "block";   
    }


    if(localStorage.getItem("to_edit") != "null"){
        
        document.getElementById("save_without_edit").style.display = "none";
        document.getElementById("save_with_edit").style.display = "flex";
