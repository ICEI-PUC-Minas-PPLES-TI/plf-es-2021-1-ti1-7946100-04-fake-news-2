...
function save_cadastro_bot(){
  ...
  let categoria1 = document.getElementById("categoria2_bot").value;
  let categoria1 = document.getElementById("categoria3_bot").value;
  let categoria1 = document.getElementById("categoria4_bot").value;
  let telefone = document.getElementById("aceito").value;
